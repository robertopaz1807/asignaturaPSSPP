package com.miteris.myasinktask;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TV_mensaje = (TextView) findViewById(R.id.tv_mensajesAlUsuario);
        Button B_probarHacerDosCosasALaVez = (Button) findViewById(R.id.bt_probarHacerOtraCosa);
        ...
        B_probarHacerDosCosasALaVez.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.v(TAG_LOG, "...Haciendo otra cosa el usuario sobre el " +
                        "hilo PRINCIPAL a la vez que carga...");
        ...
        new DescargarImagenesDeInternetEnOtroHilo(CANCELAR_SI_MAS_DE_100_IMAGENES).execute(" Estos " +
                ...
                "tipo de datos "," y podemos añadir más de 4 datos que los de este ejemplo, todos " +
                "los que necesitemos "," y recuerda que se usan como un array, para acceder en " +
                "concreto a este usaríamos variableNoUsada[3] ");
    ...
    private class DescargarImagenesDeInternetEnOtroHilo extends AsyncTask<String, Float, Integer> {
        ...
        /**
         * Constructor de ejemplo que podemos crear en el AsyncTask
         * @ param en este ejemplo le pasamos un booleano que indica si hay más de 100 archivos
         * o no. Si le pasas true se cancela por la mitad del progreso, si le pasas false seguirá
        ...
        /**
         * Se ejecuta antes de empezar el hilo en segundo plano. Después de este se ejecuta el
         * método "doInBackground" en Segundo Plano
        ...
        protected void onPreExecute() {
            ...
            miBarraDeProgreso = (ProgressBar) findViewById(R.id.pB_indicador);
        }
         ...
         * ejecuta "onPostExecute" si ha terminado, o a "onCancelled" si se ha cancelado con "cancel"
         */
        @Override
        protected Integer doInBackground(String... variableNoUsada) {
            ...
            while (!isCancelled() && cantidadImagenesDescargadas<200){
                //Suponemos que tenemos 200 imágenes en algún lado de Internet. isCancelled()
                // comprueba si hemos cancelado con cancel() el hilo en segundo plano.
                cantidadImagenesDescargadas++;
                Log.v(TAG_LOG, "Imagen descargada número " +
                        cantidadImagenesDescargadas+". Hilo en SEGUNDO PLANO");
        ...
        protected void onPostExecute(Integer cantidadProcesados) {
            TV_mensaje.setText("DESPUÉS de TERMINAR la descarga. Se han descargado  " +
                    cantidadProcesados+" imágenes. Hilo PRINCIPAL");
            Log.v(TAG_LOG, "DESPUÉS de TERMINAR la descarga. Se han descargado "+
                    cantidadProcesados+" imágenes. Hilo PRINCIPAL");
        ...
        protected void onCancelled (Integer cantidadProcesados) {
            TV_mensaje.setText("DESPUÉS de CANCELAR la descarga. Se han descargado  " +
                    cantidadProcesados+" imágenes. Hilo PRINCIPAL");
            Log.v(TAG_LOG, "DESPUÉS de CANCELAR la descarga. Se han descargado  " +
                    cantidadProcesados+" imágenes. Hilo PRINCIPAL");
